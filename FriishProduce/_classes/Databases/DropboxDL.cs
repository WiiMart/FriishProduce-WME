...
namespace FriishProduce
{
    public class DropboxDL
    {
        ...
        private static readonly List<DropboxDL> dbParams = new()
        {
            ...
            new DropboxDL("XZ1E", "Kirby-TV-Channel-Base-v4", "rlm60x81w011vyk8wl95q", "8qycrnvpicipnttorx4qi3co2", "ojsspkj3"),
            new DropboxDL("XZ1P", "Kirby-TV-Channel-Base-v4", "68yu4pn7ubftt2lruwfgc", "spmnc1kjhukcjg6oztxbcv90v", "g0agjbmw"),
